...
- BASELINE.md — Baseline metrics, commands, artifact paths
- EXECUTIVE_SUMMARY.md — 1-page summary for reviewers
- EXPERIMENTS.md — Experimental protocol and reproduction steps
- FALSIFICATION.md — Falsification scenarios and negative evidence
- FORMAL_SUMMARY_1PAGE.md — Formal summary of claims and evidence
- GOLDEN_DIAGNOSTICS.md — Diagnostics contract evidence
- HUMAN_PROXY.md — Human-proxy static metrics
- IF_FORCED_TO_CUT.md — Minimal core for artifact reduction
- KNOWN_INTENTIONAL_IMPERFECTION.md — Known limitations and imperfections
- LIMITATIONS.md — Scope and external validity limits
- RESEARCH_FRAMING.md — Framing and context for research questions
- REVIEWER_CHECKLIST.md — Reviewer audit checklist
- THESIS_CLAIM.md — Main thesis claim and rationale
- THREATS_TO_VALIDITY.md — Threats to validity and scope limitations
- RELATED_WORK.md — Related work and prior art

...
| C5 | All results are reproducible | All outputs match on rerun | make reproduce | results/*, see docs/TECH_REPORT.md (PDF: run `make tech-report-pdf`) | [results/](../results/README.md) |
